...
export function ProfileSection({ email, form, updateField, handleSave, isSaving }: ProfileSectionProps) {
  return (
    <>
      ...
      >
        <input type="number" placeholder="׳’׳™׳" value={form.age} onChange={(event) => updateField('age', event.target.value)} style={inputStyle} />
        <input type="number" placeholder="׳’׳•׳‘׳”" value={form.height} onChange={(event) => updateField('height', event.target.value)} style={inputStyle} />
